...
const Hero = () => {
  return (
    <div className="relative h-screen mb:h-[90rem]  w-screen bg-hero-bg bg-no-repeat bg-center bg-cover">
      <Navbar />
      ...
      <div className="ml-36 mt-60 2xl:mt-72 md:ml-48 sm:text-center sm:ml-0">
        <h1 className="text-9xl sm:text-8xl mb:text-7xl bold uppercase leading-relaxed">
          Be Each
          <br /> day{" "}
          <span className="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-primary-200 relative inline-block">
